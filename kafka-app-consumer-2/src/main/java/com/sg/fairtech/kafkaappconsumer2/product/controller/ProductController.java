package com.sg.fairtech.kafkaappconsumer2.product.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.sg.fairtech.kafkaappconsumer2.product.ProductService;
import com.sg.fairtech.kafkaappconsumer2.product.assembler.ProductAssembler;
...
public class ProductController {
    ...
    public String triggerSyncProduct(@RequestParam Map<String, String> params) {
